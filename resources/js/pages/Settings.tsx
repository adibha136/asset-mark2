...
export default function Settings() {
  ...
  const [inactiveCheckTime, setInactiveCheckTime] = useState("00:00");
  ...
  const fetchInitialData = async () => {
    try {
      ...
      setInactiveCheckTime(syncSettingsRes.data.inactiveCheckTime || "00:00");
                    ...
                    <div className="flex items-center justify-between p-4 rounded-xl bg-muted/30">
                      ...
                      <div className="flex items-center gap-2">
                        <Input 
                          ...
                          value={inactiveCheckTime}
                          onChange={(e) => {
                            setInactiveCheckTime(e.target.value);
                            saveSyncSettings({ inactiveCheckTime: e.target.value });
                          }}
                        />
                        <Badge variant="secondary">Daily</Badge>
                      </div>
