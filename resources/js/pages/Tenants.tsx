...
import { Plus, Search, Building2, Users, Package, MoreHorizontal, Edit, Trash2, Eye, EyeOff, Settings, RefreshCw, ExternalLink, Info, Shield } from "lucide-react";
        ...
        {filteredTenants.map((tenant, index) => (
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 pt-4 border-t border-border">
              <div className="flex items-center gap-2" title="Total Users">
                <Users className="w-3.5 h-3.5 text-muted-foreground shrink-0" />
                <span className="text-xs font-bold text-foreground">{tenant.total_users_count || 0}</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-wider whitespace-nowrap">Total</span>
              </div>
              <div className="flex items-center gap-2" title="Active Users">
                <div className="w-1.5 h-1.5 rounded-full bg-success shrink-0" />
                <span className="text-xs font-bold text-foreground">{tenant.active_users_count || 0}</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-wider whitespace-nowrap">Active</span>
              </div>
              <div className="flex items-center gap-2" title="Inactive Users">
                <div className="w-1.5 h-1.5 rounded-full bg-destructive shrink-0" />
                <span className="text-xs font-bold text-foreground">{tenant.inactive_users_count || 0}</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-wider whitespace-nowrap">Inactive</span>
              </div>
              <div className="flex items-center gap-2" title="Licensed Users">
                <Shield className="w-3.5 h-3.5 text-primary shrink-0" />
                <span className="text-xs font-bold text-foreground">{tenant.licensed_users_count || 0}</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-wider whitespace-nowrap">Licensed</span>
              </div>
              <div className="flex items-center gap-2" title="Unlicensed Users">
                <Shield className="w-3.5 h-3.5 text-warning shrink-0" />
                <span className="text-xs font-bold text-foreground">{tenant.unlicensed_users_count || 0}</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-wider whitespace-nowrap">Unlicensed</span>
              </div>
              <div className="flex items-center gap-2">
                <Package className="w-3.5 h-3.5 text-muted-foreground shrink-0" />
                <span className="text-xs font-bold text-foreground">{tenant.assigned_assets_count || 0}</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-wider whitespace-nowrap">Assets</span>
              </div>
            </div>
          </div>
        ))}
          ...
          <div className="grid gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  <h4 className="text-sm font-medium text-muted-foreground mb-3">User Statistics</h4>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 rounded-xl bg-muted/50 border border-border">
                      <p className="text-xs text-muted-foreground uppercase tracking-wider">Total Users</p>
                      <p className="text-xl font-bold">{selectedTenant.total_users_count || 0}</p>
                    </div>
                    <div className="p-3 rounded-xl bg-success/5 border border-success/10">
                      <p className="text-xs text-success/70 uppercase tracking-wider">Active</p>
                      <p className="text-xl font-bold text-success">{selectedTenant.active_users_count || 0}</p>
                    </div>
                    <div className="p-3 rounded-xl bg-destructive/5 border border-destructive/10">
                      <p className="text-xs text-destructive/70 uppercase tracking-wider">Inactive</p>
                      <p className="text-xl font-bold text-destructive">{selectedTenant.inactive_users_count || 0}</p>
                    </div>
                    <div className="p-3 rounded-xl bg-primary/5 border border-primary/10">
                      <p className="text-xs text-primary/70 uppercase tracking-wider">Licensed</p>
                      <p className="text-xl font-bold text-primary">{selectedTenant.licensed_users_count || 0}</p>
                    </div>
                    <div className="p-3 rounded-xl bg-warning/5 border border-warning/10">
                      <p className="text-xs text-warning/70 uppercase tracking-wider">Unlicensed</p>
                      <p className="text-xl font-bold text-warning">{selectedTenant.unlicensed_users_count || 0}</p>
                    </div>
                    <div className="p-3 rounded-xl bg-accent/5 border border-accent/10">
                      <p className="text-xs text-accent/70 uppercase tracking-wider">Assets</p>
                      <p className="text-xl font-bold text-accent">{selectedTenant.assigned_assets_count || 0}</p>
                    </div>
                  </div>
                </div>
